                        ...
                        <table id="table-list" class="table table-striped table-hover">
                            ...
                            <tbody>
                            	<?php foreach( $lista as $pg ):?>
	                                <tr id="list<?=$pg['id_galerias'];?>" class="list">
	                                    <td class="col-sm-1 text-center">
											<a href="<?php echo $adm_uri . 'status/'?>" class="btn btn-xs changestatus" data-id="<?=$pg['id_galerias'];?>">	                                    	
	                                    		<i class="fa fa-power-off <?=($pg['status']==1) ? 'on' : 'off';?>"></i>
	                                    	</a>
	                                    </td>
	                                    <td class="text-muted"><?=$pg['titulo'];?></td>
	                                    <td>
		                    	            <a href="<?php echo $edit_uri . $pg['id_galerias']?>" class="btn btn-primary btn-xs">Editar</a>
	                                        <a href="<?php echo $del_uri . $pg['id_galerias']?>" class="btn btn-primary btn-xs rem">Remover</a>
	                                    </td>
	                                </tr>
	                            <?php endforeach; ?>
                            </tbody>
