...
,data:{
nome:getValue($('label.name input'))
,email:getValue($('label.email input'))
,telefone:getValue($('label.phone input'))
,mensagem:getValue($('label.message textarea'))
...
$(window).load(function(){
        $('#form').TMForm({
            ownerEmail:'contato@estefanbombonato.com.br'
        })
